...
data.raw["assembling-machine"]["foundry"].crafting_speed = 3
...
data.raw["assembling-machine"]["electromagnetic-plant"].crafting_categories = {"hand-assembly-electronics-quantum", "assembly-electronics-quantum", "electromagnetics", "electronics", "electronics-with-fluid", "electronics-or-assembling", "electronics-quantum",}
