...
local mefitis_base_tint = {1,1,1}

local tintable_rock_tint = {0.38, 0.22, 0.19}
...
data:extend{
  ...
  ---- CHLORINE
  {
    ...
    name = "mefitis_chlorine_puddle",
    expression = "min(0.2, min(0.5, 3 * (mefitis_chlorine_region_patchy + 0.1)) - 0.6 - 0.6 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_chlorine_puddle_small",
    expression = "min(0.25, min(0.5, 3 * (mefitis_chlorine_region_patchy + 0.15)) - 0.6 - 0.6 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_chlorine_stain",
    expression = "min(0.2, min(0.5, 3 * (mefitis_chlorine_region_patchy + 0.1)) - 0.8 - 0.6 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_chlorine_stain_small",
    expression = "max(min(0.1, mefitis_chlorine_region_patchy),\z
                      min(0.2, min(0.5, 3 * (mefitis_chlorine_region_patchy + 0.2)) - 0.4 + 0.6 * mefitis_decorative_knockout))"
  },
  {
    type = "noise-expression",
    name = "mefitis_small_chlorine_rock",
    expression = "min(0.4, min(0.5, 3 * (mefitis_chlorine_region_patchy + 0.1)) - 0.7 + 0.6 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_chlorine_rock_cluster",
    expression = "min(0.1, min(0.5, 3 * (mefitis_chlorine_region_patchy)) - 0.6 + 0.6 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_chlorine_rock_tiny",
    expression = "min(0.5, min(0.5, 3 * (mefitis_chlorine_region_patchy + 0.2)) - 0.4 + 0.6 * mefitis_decorative_knockout)"
  },
  ...
  {
    type = "noise-expression",
    name = "mefitis_rock_huge",
    expression = "min(0.2 * (1 - 0.75 * mefitis_ashlands_biome), - 1.2 + 1.2 * min(aux, -0.1 + 1.1 * moisture) + mefitis_rock_noise + 0.5 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_rock_big",
    expression = "min(0.2 * (1 - 0.5 * mefitis_ashlands_biome), - 1.0 + 1.2 * min(aux, -0.1 + 1.1 * moisture) + mefitis_rock_noise + 0.5 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_rock_medium",
    expression = "min(0.5 * (1 - 0.5 * mefitis_ashlands_biome), - 0.8 + 1.2 * min(aux, -0.1 + 1.1 * moisture) + mefitis_rock_noise + 0.5 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_rock_cluster",
    expression = "min(0.2 * (1 - 0.5 * mefitis_ashlands_biome), - 0.7 + 1.2 * min(aux, -0.1 + 1.1 * moisture) + mefitis_rock_noise + 0.5 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_rock_small",
    expression = "min(0.6 * (1 - 0.5 * mefitis_ashlands_biome), - 0.6 + 1.2 * min(aux, -0.1 + 1.1 * moisture) + mefitis_rock_noise + 0.5 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_rock_tiny",
    expression = "min(0.75 * (1 - 0.5 * mefitis_ashlands_biome), - 0.5 + 1.2 * min(aux, -0.1 + 1.1 * moisture) + mefitis_rock_noise + 0.5 * mefitis_decorative_knockout)"
  },

  ---- DECALS
  {
    type = "noise-expression",
    name = "mefitis_crack_decal_large",
    expression = "min(0.2, range_select_base(mefitis_elev, 20, 50, 1, -10, 1) - 0.1 - 0.25 * aux + 0.25 * (moisture - 0.6) + 0.5 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_crack_decal",
    expression = "min(0.2, range_select_base(mefitis_elev, 50, 90, 1, -10, 1) - 0.1 - 0.25 * aux + 0.25 * (moisture - 0.6) + 0.5 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_crack_decal_huge_warm",
    expression = "mefitis_basalts_biome * min(0.3, range_select_base(mefitis_elev, 0, 10, 1, -10, 1) - 0.1 - 0.25 * aux + 0.25 * (moisture - 0.6) + 0.5 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_crack_decal_warm",
    expression = "mefitis_basalts_biome * min(0.2, range_select_base(mefitis_elev, 10, 30, 1, -10, 1) - 0.1 - 0.25 * aux + 0.25 * (moisture - 0.6) + 0.5 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
    name = "mefitis_rock_decal_large",
    expression = "min(0.1, range_select_base(mefitis_elev, 20, 50, 1, -10, 1) - 0.6 + 0.25 * aux + 0.25 * (moisture - 0.6) + 0.5 * mefitis_decorative_knockout)"
  },
  {
    type = "noise-expression",
  ...
  },
  {
    ...
    expression = "(1 - aux - moisture) * 0.05 * place_every_n(5.7,5.7,1,1) * mefitis_ashlands_biome"
  },

  {
    type = "noise-expression",
    name = "mefitis_sand_decal",
    expression = "(1 - aux - moisture) * 0.05 * mefitis_basalts_biome"
  },
  {
    type = "noise-expression",
    name = "mefitis_dune_decal",
    expression = "(1 - aux - moisture) * 0.05 * mefitis_ashlands_biome"
  },

  {
    type = "noise-expression",
    name = "crater_small",
    expression = "min(0.1, 0.3 - mefitis_rock_noise - aux)"
  },
  {
    type = "noise-expression",
    name = "crater_large",
    expression = "min(0.15, (0.2 - mefitis_rock_noise - aux) * place_every_n(3,3,0,0))"
  },
  {
    type = "noise-expression",
    name = "crater_cliff",
    expression = "0.5 * (mefitis_rock_noise + 0.5 * aux - 0.5 * moisture) * (1 - max(mefitis_basalts_biome,mefitis_ashlands_biome)) * place_every_n(21,21,0,0)"
  },
  
  ---ROCKY DECALS
  {
    name = "mefitis-rock-decal-large",
    type = "optimized-decorative",
    order = "a[mefitis]-b[decorative]-b[sand]",
  ...
  --- LARGE CRACK DECALS
  {
    ...
    autoplace = {
      ...
      probability_expression = "mefitis_crack_decal_large"
    },
  ...
  {
    name = "mefitis-crack-decal-huge-warm",
    type = "optimized-decorative",
    order = "a[mefitis]-b[decorative]-b[sand]",
  ...
  --- WARM CRACK DECALS
  {
    ...
    autoplace =
    {
      ...
      probability_expression = "mefitis_crack_decal_warm"
    },
  ...
  --- Chlorine STAINS
  {
    ...
    autoplace = {
      ...
      probability_expression = "mefitis_chlorine_stain"
    },
  ...
  --- SPOTTY chlorine STAINS
  {
    ...
    autoplace = {
      ...
      probability_expression = "mefitis_chlorine_stain_small"
    },
  ...
  --- chlorine-PUDDLE
  {
    ...
    autoplace =
    {
      ...
      placement_density = 2,
      probability_expression = "mefitis_chlorine_puddle"
    },
  ...
  --- chlorine-PUDDLE-SMALL
  {
    ...
    autoplace =
    {
      ...
      placement_density = 2,
      probability_expression = "mefitis_chlorine_puddle_small"
    },
  ...
  },
  {
    ...
    autoplace = {
      ...
      probability_expression = "mefitis_dune_decal"
    },
  ...
  --- BIG ROCKS
  {
    name = "huge-cryovolcanic-rock",
    type = "simple-entity",
    flags = {"placeable-neutral", "placeable-off-grid"},
    icon = "__outer_moons__/graphics/icons/huge-mefitis-rock.png",
    subgroup = "grass",
    order = "b[decorative]-l[rock]-f[huge-cryovolcanic-rock]",
    ...
    minable =
    {
      ...
      results =
      {
        ...
        {type = "item", name = "heavy-metal", amount_min = 6, amount_max = 18},
      },
    },
    ...
    autoplace = {
      ...
      probability_expression = "mefitis_rock_huge"
    },
    pictures =
    {
      {
  ...
  {
    name = "big-cryovolcanic-rock",
    type = "simple-entity",
    flags = {"placeable-neutral", "placeable-off-grid"},
    icon = "__outer_moons__/graphics/icons/big-mefitis-rock.png",
    subgroup = "grass",
    order = "b[decorative]-l[rock]-f[big-cryovolcanic-rock]",
    ...
    autoplace = {
      ...
      probability_expression = "mefitis_rock_big"
    },
    ...
    minable =
    {
      ...
      results =
      {
        ...
        {type = "item", name = "heavy-metal", amount_min = 5, amount_max = 9},
      }
    },
    resistances =
    {
  ...
  --- MEDIUM BLACK ROCKS
  {
    ...
    autoplace = {
      ...
      probability_expression = "mefitis_rock_medium"
    },
  ...
  --- SMALL BLACK ROCKS
  {
    ...
    autoplace =
    {
      ...
      probability_expression = "mefitis_rock_small"
    },
  ...
  --- TINY TINTABLE ROCKS
  {
    ...
    autoplace =
    {
      ...
      placement_density = 5,
      probability_expression = "mefitis_rock_tiny"
    },
    trigger_effect = decorative_trigger_effects.small_rock(),
    pictures =
    {
  ...
  --- SMALL ROCKS
  {
    ...
    autoplace =
    {
      ...
      placement_density = 2,
      probability_expression = "mefitis_small_chlorine_rock"
    },
    trigger_effect = decorative_trigger_effects.small_rock(),
    pictures =
    {
  ...
  --- TINY ROCKS
  {
    ...
    autoplace =
    {
      ...
      placement_density = 5,
      probability_expression = "mefitis_chlorine_rock_tiny"
    },
    trigger_effect = decorative_trigger_effects.small_rock(),
    pictures =
    {
  ...
  --- ROCK CLUSTERS
  {
    ...
    autoplace =
    {
      ...
      placement_density = 2,
      probability_expression = "mefitis_chlorine_rock_cluster"
    },
  ...
  {
    type = "optimized-decorative",
    name = "mefitis-lava-fire",
    order = "b[effect]-l[fire]-h[mefitis-lava-fire]",
    collision_box = {{-1, -1}, {1, 1}},
    collision_mask = {layers={ground_tile=true}, colliding_with_tiles_only=true},
    autoplace =
    {
      order = "d[ground-surface]-k[lava]",
      probability_expression = "0.1 * (mefitis_elev <= 0) * (mefitis_elev > 2)\z
