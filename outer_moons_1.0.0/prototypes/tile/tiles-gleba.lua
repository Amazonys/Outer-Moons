  ...
  ---- LAND
    ---- Lowland
      ...
      },
      {
        ...
        autoplace = {probability_expression = "0"}, --gleba_fertile_solid * 50000 - 40000 - gleba_biome_mask_green * 1000000
        transitions = lava_stone_transitions,
        transitions_between_transitions = lava_stone_transitions_between_transitions,
        walking_sound = semi_wet_sound,
        landing_steps_sound = tile_sounds.landing.semi_wet,
      ...
      ----------- Red vein
      {
		...
		autoplace = {probability_expression = "gleba_lowland * gleba_select(gleba_aux, 0.75, 1, 0.005, 0, 1) + 0.1 * (gleba_plants_noise_b - 1)"},transitions = lava_stone_transitions,
        transitions_between_transitions = lava_stone_transitions_between_transitions,
        walking_sound = semi_wet_sound,
        landing_steps_sound = tile_sounds.landing.semi_wet,
        map_color={115, 53, 66},
      ...
      },
      {
        ...
        autoplace = {probability_expression = "0"}, --gleba_fertile_solid * 50000 - 10000 - gleba_biome_mask_red
        transitions = lava_stone_transitions,
        transitions_between_transitions = lava_stone_transitions_between_transitions,
        walking_sound = semi_wet_sound,
        map_color={115, 53, 66},
...
data:extend({
  {
    ...
    autoplace = {probability_expression = "gleba_shallows_edge_aux_1 + 10 * min(gleba_select(gleba_aux, 0, 0.3, 0.005, 0, 1), gleba_rockpools_shallow)"},
