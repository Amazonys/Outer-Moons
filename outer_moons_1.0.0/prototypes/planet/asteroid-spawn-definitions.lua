...
asteroid_functions.nauvis_ratio      = {3, 2, 1, 1 , 0}
asteroid_functions.selene_ratio      = {3, 2, 2, 1 , 0}
asteroid_functions.vulcanus_ratio    = {5, 2, 1, 1 , 0}
asteroid_functions.gleba_ratio       = {2, 5, 1, 1 , 0}
asteroid_functions.fulgora_ratio     = {4, 3, 1, 1 , 0}
asteroid_functions.aquilo_ratio      = {1, 2, 1, 20, 0}
asteroid_functions.system_edge_ratio = {3, 5, 1, 2 , 0}

asteroid_functions.nauvis_chunks      = 0.0125
asteroid_functions.selene_chunks      = 0.0150
asteroid_functions.selene_medium      = 0.0020
...
asteroid_functions.nauvis_selene =
{
  probability_on_range_chunk =
  {
    {position = 0.1, probability = asteroid_functions.nauvis_chunks, angle_when_stopped = asteroid_functions.chunk_angle},
    {position = 0.9, probability = asteroid_functions.selene_chunks, angle_when_stopped = asteroid_functions.chunk_angle}
  },
  probability_on_range_medium =
  {
    {position = 0.1, probability = 0, angle_when_stopped = asteroid_functions.medium_angle},
    {position = 0.5, probability = asteroid_functions.selene_medium * 2, angle_when_stopped = asteroid_functions.medium_angle},
    {position = 0.9, probability = asteroid_functions.selene_medium, angle_when_stopped = asteroid_functions.medium_angle}
  },
  type_ratios =
  {
    {position = 0.1, ratios = asteroid_functions.nauvis_ratio},
    {position = 0.9, ratios = asteroid_functions.selene_ratio},
  }
}
...
asteroid_functions.aquilo_solar_system_edge =
{
  ...
  type_ratios =
  {
    ...
    {position = 0.2, ratios = {2,3,2,10, 0}},
    {position = 0.3, ratios = {4,2,2,8, 0}},
    {position = 0.4, ratios = {6,1,1,4, 0}},
    {position = 0.5, ratios = {9,4,3,3, 0}},
    {position = 0.6, ratios = {9,5,4,2, 0}},
    {position = 0.7, ratios = {9,2,2,7, 0}},
    {position = 0.8, ratios = {3,5,3,1, 0}},
...
asteroid_functions.shattered_planet_trip =
{
  ...
  type_ratios =
  {
    ...
    {position = 0.002, ratios = { 3/10*16,5/10*16,4/10*16,2/10*16,  0.04  }},-- 3 5 4 2
    {position = 0.2,   ratios = { 5,3,2,8,    0.40 }},
    {position = 0.3,   ratios = { 3,9,6,4,    2.03 }},
    {position = 0.4,   ratios = { 7,6,4,3,    6.40 }},
    {position = 0.5,   ratios = { 9,2,2,5,   15.63 }},
    {position = 0.6,   ratios = { 2,6,3,8,   32.40 }},
    {position = 0.7,   ratios = { 8,2,2,5,   60.03 }},
    {position = 0.8,   ratios = { 3,9,5,4,  102.40 }},
    {position = 0.999, ratios = { 10,2,2,4, 164.03 }},
  }
}
...
asteroid_functions.spawn_definitions = function(data, planet)
  ...
  local asteroid_types = {"metallic", "carbonic", "silicaceous", "oxide"}
  if data.has_promethium_asteroids == true then
    asteroid_types = {"metallic", "carbonic", "silicaceous", "oxide", "promethium"}
  end
  for k, asteroid_size in pairs(asteroid_sizes) do
    for k, asteroid_type in pairs(asteroid_types) do
      ...
      elseif asteroid_type == "carbonic" then
        asteroid_id = 2
      elseif asteroid_type == "silicaceous" then
        asteroid_id = 3
